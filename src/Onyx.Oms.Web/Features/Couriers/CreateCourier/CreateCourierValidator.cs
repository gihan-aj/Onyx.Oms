...
public class CreateCourierValidator : AbstractValidator<CreateCourierCommand>
{
    public CreateCourierValidator()
    {
        ...
        When(c => c.ZoneRates != null && c.ZoneRates.Any(), () =>
        {
            ...
            RuleForEach(c => c.ZoneRates).SetValidator(new CreateCourierZoneRateDtoValidator());
        });
    }
}

public class CreateCourierZoneRateDtoValidator : AbstractValidator<CreateCourierZoneRateDto>
{
    public CreateCourierZoneRateDtoValidator()
    {
