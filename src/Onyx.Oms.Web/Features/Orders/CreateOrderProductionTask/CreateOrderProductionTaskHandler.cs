...
{
    public class CreateOrderProductionTaskHandler : ICommandHandler<CreateOrderProductionTaskCommand, Guid>
    {
        private readonly IApplicationDbContext _context;
        private readonly ICurrentUserService _currentUserService;

        public CreateOrderProductionTaskHandler(IApplicationDbContext context, ICurrentUserService currentUserService)
        {
            _context = context;
            _currentUserService = currentUserService;
        }

        public async Task<Result<Guid>> Handle(CreateOrderProductionTaskCommand request, CancellationToken cancellationToken)
        {
            ...
            var taskResult = FulfillmentTask.Create(
                tenantId.Value,
                FulfillmentTaskType.Production,
